...
public class KitchenEmployee implements CommandReceiver {
    private final int HOURLY_WAGE = 11000;
    ...
    public void onWork() {
        ...
        System.out.println("Kitchen Employee " + employee.getName() + " is on work");
    ...
    public void offWork() {
        ...
        System.out.println("Kitchen Employee " + employee.getName() + " is off work");
